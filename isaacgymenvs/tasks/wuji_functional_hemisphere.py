"""Wuji multi-grasp teacher with the pretrained knife observation convention.
...
class WujiFunctionalHemisphere(WujiVariableTimedAcquisition):
    def __init__(self, cfg, *args, **kwargs):
        ...
        if asset_root != 'assets/objects/knife_wuji_lowgain_functional20_20260922':
            raise ValueError('This task requires the frozen functional20 original-axis asset')
