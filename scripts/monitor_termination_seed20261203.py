...
root=Path("/home/wangjiarui/artgym-experiments-20260921");g=root/'runs/wuji-goal';d=g/'diagnostics';out=d/'termination-seed20261203-20260924-audit-v1';out.mkdir(exist_ok=False)
pin=Path('/home/wangjiarui/artgym-pinned-termination-multiseed-20260924-v1');queue=g/'termination-seed20261203-20260924-evaluation-queue-v1.json'
...
try:
 while True:
  ...
  if completed and completed!=previous:
   ...
   cmd=['/home/wangjiarui/artgym-runtime/bin/python','-m','scripts.audit_wuji_reset_range_cp_results','--root',str(root),'--queue',str(queue),'--output',str(target),'--allow-partial','--protocol-label','eight-H100 GPU4, batch332']
   ...
   save()
  coordinator_path=d/'termination-seed20261203-20260924-evaluations-v1/status.json'
