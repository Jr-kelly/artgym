...
def main():
    ...
    for maximum in [args.maximum]:
        cfg = configuration('wuji_acquisition_bridge3_hemisphere', 12,
            ['hand=wuji_paper_official_actuator', 'object=knife_wuji_bridge3_20260922',
             'test=False', 'object.reward.GoalDistance2=5.0',
             'task.env.episodeLength=' + str(maximum)], train='wujiAcquisitionSAPG', seed=20261058)
    ...
    files = ['scripts/check_wuji_bridge3_episode_duration.py', 'isaacgymenvs/tasks/wuji_bridge3_hemisphere.py', 'isaacgymenvs/cfg/task/wuji_acquisition_bridge3_hemisphere.yaml', 'isaacgymenvs/tasks/artmanip.py',
