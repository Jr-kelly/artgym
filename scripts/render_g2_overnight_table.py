...
def main():
    ...
    for trial in data['trials']:
        ...
        row=dict(trial=trial['name'],kind='development',group=group,status=trial['status'],physical_execution=trial.get('physical_execution'),
            ...
            g1_original_plan_gate_passed=trial.get('g1_passed'),
            observed_thumb_free_stable_hold=bool(trial.get('observed_thumb_free_stable_holds')),
            observed_thumb_free_supports=json.dumps([v['supports_at_least_90pct'] for v in trial.get('observed_thumb_free_stable_holds',[])]),
