...
def main():
    ...
    input_flags=['--teacher','--student','--grasp-plan','--seating-plan','--operation-pose','--table-regrasp-plan','--post-acquisition-pose','--gait-plan','--operation-seed','--acquisition-arm-seed','--post-roll-gait-plan','--preset-candidate']
    ...
    for flag in input_flags:
        if flag in args:
            ...
            if flag not in ['--teacher','--student']:
