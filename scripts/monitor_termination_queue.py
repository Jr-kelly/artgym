...
root=Path("/home/wangjiarui/artgym-experiments-20260921");g=root/'runs/wuji-goal';d=g/'diagnostics';out=d/'termination-cp-audit-monitor-eight-20260923-v1';out.mkdir(exist_ok=False)
pin=Path('/home/wangjiarui/artgym-pinned-termination-pair-20260923-v1');queue=g/'termination-evaluation-20260923-h100-v1-queue.json'
...
try:
 while True:
  ...
  if completed and completed!=previous:
   ...
   cmd=['/home/wangjiarui/artgym-runtime/bin/python','-m','scripts.audit_wuji_reset_range_cp_results','--root',str(root),'--queue',str(queue),'--output',str(target),'--allow-partial','--protocol-label','eight-H100 GPU1, batch332']
   ...
   save()
  coordinator_path=d/'termination-evaluations-eight-20260923-v1/status.json'
