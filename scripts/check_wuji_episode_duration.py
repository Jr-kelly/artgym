...
def main():
    ...
    for maximum in [args.maximum]:
        cfg = configuration('wuji_acquisition_official_variable_timed', 12,
            ['hand=wuji_paper_official_actuator', 'object=knife_wuji_precision_near01',
             'test=False', 'object.reward.GoalDistance2=5.0',
             'task.env.episodeLength=' + str(maximum)], train='wujiAcquisitionSAPG', seed=20261033)
    ...
    files = ['scripts/check_wuji_episode_duration.py', 'isaacgymenvs/tasks/artmanip.py',
