...
root=Path("/home/wangjiarui/artgym-experiments-20260921");g=root/'runs/wuji-goal';d=g/'diagnostics';out=d/'termination-seed20261201-20260924-audit-v1';out.mkdir(exist_ok=False)
pin=Path('/home/wangjiarui/artgym-pinned-termination-multiseed-20260924-v1');queue=g/'termination-seed20261201-20260924-evaluation-queue-v1.json'
...
try:
 while True:
  ...
  if completed and completed!=previous:
   ...
   save()
  coordinator_path=d/'termination-seed20261201-20260924-evaluations-v1/status.json'
