"""Gate all five actor-input interventions before full fixed-state diagnostics."""
import argparse
import json
    ...
    try:
        ...
        for runtime in [True,False]:
            for mode in modes:
                ...
                cmd=[sys.executable,'-m','scripts.probe_wuji_teacher_inputs','--output',str(destination),
