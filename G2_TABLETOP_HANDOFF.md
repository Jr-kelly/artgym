...
## Overnight G2 20260926 2026-09-25T23:54:40.707562+00:00

R3-16已启动，总开发48/48（每轮16次）。最后控制只新增中指两远端的物体材料点全位置反馈，normal模式旧代码与所有在途源码pin保留；不再启动开发物理或绕用验证额度。此前静态、动作消融、同腕A已收齐，学习0GPUh、正式验证0/20。等待末试验完整终态，同时整理四组接管对照、全部开发表和增量Release。

续接：runs/g2-overnight-20260926/task-state.json；research/g2-overnight-20260926.md。独立分支feat/g2-wuji-overnight-20260926。开发截止北京时间09:07:35，总截止09:52:35。

## Overnight G2 20260926 2026-09-25T23:53:57.466993+00:00

三组接管对照收齐：R3-13固定电机20秒仍旋转0.550264rad，2.7333s首次越界，中指接触13.17%；R3-14仅拇指动作保住100%滑块接触并有41.989mm行程/后一轮开合，但首端点26.703mm、世界19.981mm/.978801rad，仍失败，不能将q4负动作认定必然导致离触。最后R3-16改检验支持长期保持：静态轨迹在失稳前中指材料点切向误差0.73-0.93mm，两远端关节线性修正约[+.015,-.049]rad可达；只加法向的影子控制不能覆盖该偏移，故单列全位置误差反馈。原3/s、±.08rad、.2rad/s、1e-6阻尼；18个实际/目标包络含掌部和自身检查无新增交集，首命令0、正关节扰动反向修正、共同刚体平移不产生残差。新试验相同桌面前缀后22秒中指反馈保持，其他目标固定，原gait世界参考/门禁不动；通过后停止反馈保留真实目标，2秒真实历史，再完整冻结teacher20秒。明示实时物体真值控制上界，不执行student。

续接：runs/g2-overnight-20260926/task-state.json；research/g2-overnight-20260926.md。独立分支feat/g2-wuji-overnight-20260926。开发截止北京时间09:07:35，总截止09:52:35。

## Overnight G2 20260926 2026-09-25T23:38:07.657461+00:00

同腕R3-15独立A成功：冻结teacher两轮，端点0.810/0/0.068/0mm，固定世界4.450mm/0.239632rad，无掉落、滑块接触100%。相同腕姿存在功能操作条件；连续R3-12仍失败，不能仅凭此唯一归因于抓姿。R3-13静态20s及R3-14仅拇指动作仍运行；原训练88339实查活跃，GPU98%。Github实际分支核验为b5afdcc，origin是本机备份不是Github，后续公开核验均用Jr-kelly/artgym明确URL。

续接：runs/g2-overnight-20260926/task-state.json；research/g2-overnight-20260926.md。独立分支feat/g2-wuji-overnight-20260926。开发截止北京时间09:07:35，总截止09:52:35。

## Overnight G2 20260926 2026-09-25T23:33:03.758190+00:00

同腕A准备核查发现已有两A腕朝向与当前B分别差0.386/0.675rad，不能直接当同条件对照。R3-15已启动功能抓姿0+当前B腕姿的独立A，首物理步前初始化，原物性/完整冻结teacher/实际历史；G2 IK与自身/桌面预检通过。R3-13静态20s和R3-14仅拇指输出仍运行。当前47/48启动，最后1次保留给有证据的接管修正或student，不能重复无信息试验。

续接：runs/g2-overnight-20260926/task-state.json；research/g2-overnight-20260926.md。独立分支feat/g2-wuji-overnight-20260926。开发截止北京时间09:07:35，总截止09:52:35。

## Overnight G2 20260926 2026-09-25T23:29:41.751567+00:00

R3-12完整teacher600步结束失败：滑块行程0.937mm，四端点39.957/.857/39.084/.937mm，世界39.348mm/3.073382rad，0完整周期；没有落桌，但操作姿态失控。接管后0.1667s首次失去滑块接触，0.6667s首次稳定越界，首命令变化0.01850rad；实际历史50帧，RNN一次清零，滑块真实闭合未复位。R3-13从相同桌面前缀做原目标不动20s对照（总settle22s，未执行策略）；R3-14单列动作分量消融，仅执行冻结teacher拇指输出、非拇指目标保持。消融不等同原全手策略，权重/物性/阈值不变；raw输出与实际执行动作分别记录，last_action和历史均使用真正执行值。剩余2次开发，未运行student。

续接：runs/g2-overnight-20260926/task-state.json；research/g2-overnight-20260926.md。独立分支feat/g2-wuji-overnight-20260926。开发截止北京时间09:07:35，总截止09:52:35。

## Overnight G2 20260926 2026-09-25T23:23:42.633570+00:00

R3-12真实桌面连续路线已通过G2并进入冻结teacher：thumb-only接近接触迁移后，滑块接触末1秒拇指100%，食指/中指/小指100%，无名指0；固定世界5.677mm/.091366rad，无落桌/掉落。G1与自由预备点的原4.1mm门禁通过，实际后续接触与保持通过；随后2秒真实历史停稳并接管。正在完成20秒两轮，不提前宣称teacher整段成功。

续接：runs/g2-overnight-20260926/task-state.json；research/g2-overnight-20260926.md。独立分支feat/g2-wuji-overnight-20260926。开发截止北京时间09:07:35，总截止09:52:35。

## Overnight G2 20260926 2026-09-25T23:15:19.571404+00:00

允许PhysX途中接近接触的单列迁移案找到3路点/2段thumb-only路径：几何正间隙>=0.2mm、完整稠密整指/指间/掌部采样通过，不叫全程自由运动。G1初始和预备位各1秒仍要求4.1mm/全无触，最后保持要求真实拇指-滑块接触及食中小支持，世界10mm/.25rad不变。R3-12已从桌面启动，前置门禁全部通过才接冻结teacher20秒两轮。原无名指让位备选几何已通过（修正5.6e-8rad浮点审核问题，未动实际限位），暂不物理执行。新增滑块接触计数已与R3-11原始contact-pairs逐帧重建完全一致。

续接：runs/g2-overnight-20260926/task-state.json；research/g2-overnight-20260926.md。独立分支feat/g2-wuji-overnight-20260926。开发截止北京时间09:07:35，总截止09:52:35。

## Overnight G2 20260926 2026-09-25T23:13:24.054017+00:00

07:14方向复核：G1已有实际三指保持/整拇指离触证据，优先级已转为G2路径。冻结腕的直接/先屈/深屈三类几何路径均未连通，最后6000轮扩展到154/295节点仍失败；最近跨树直连真正穿过刀体，不能直接执行。正在单列允许PhysX途中接近接触、但几何正间隙的迁移屏，G1与终点离触标准仍4.1mm且世界判据不变。3mm腕备选被已卸载无名指挡住，先移开该无载指的几何通过，旧审核false仅因未动拇指float32目标超double上限5.6e-8rad；将审核浮点容差对齐原执行器1e-6，不改限位或物理，旧报告保留。学习仍不启动：当前需要先找到可执行几何通路，不能用RL代替不可达/接口排查。剩余5次开发物理，继续有界路线，不将G1当最终目标。
