...
## Overnight G2 20260926 2026-09-25T23:04:10.998516+00:00

R3-11成功完成实际G1：末1秒整拇指30/30无触、最小间隙5.296mm，食指/中指/小指100%接触，固定世界5.618mm/.060983rad。原四非拇指门禁因无名指0接触失败，原退出码/轨迹保留；后续明确选用已有1秒证据的三指支撑，不改数值标准。与R3-10前1929帧完全相同，拇指/其余三指全部命令相同，仅无名指卸预载，支持其影响横向保持但不证明唯一根因。实际末态闭合滑块接触点重新IK通过，首有界RRT未连通；局部几何显示先屈拇指第4关节增加间隙，再迁移其余关节更合理，正做该有限路径屏。
...
## Overnight G2 20260926 2026-09-25T22:54:18.197684+00:00

食指左侧+10mm、小指左侧-55mm两个有限几何案均拒绝，原G1新增8分支拇指屏也未通过；未启动这些物理。R3-10前状态的驱动模型K*(目标-q)-D*qdot及静态Jacobian估计显示无名指向-x作用显著，模型mu1最小支撑解却不需无名指法向力；这不是实测力，拇指/食指还有限位反力未建模。R3-11保留R3-10完全相同拇指轨迹，仅同步将无名指预载目标退到释放前实际q；其余三指命令、末四支撑/离触/世界判据不变。正在物理检验是否减小失控横移，不提前归因。

续接：runs/g2-overnight-20260926/task-state.json；research/g2-overnight-20260926.md。独立分支feat/g2-wuji-overnight-20260926。开发截止北京时间09:07:35，总截止09:52:35。

## Overnight G2 20260926 2026-09-25T22:49:50.533402+00:00

R3-10释放失败，完整前1899帧与R3-09逐项相同；64.8667s中指先失触，64.9000s小指随后失触，65.0333s固定世界位移越界。末12.350mm/.234544rad，拇指仅1帧无触、末整指gap仍负。刀相对释放前在刀坐标移动[-8.042,-.422,-3.784]mm；静力有解不能当执行支持。停止盲目增大退出幅度；几何预筛食指左侧对向支持，保留小指底部及拇指/中指/无名指，只有可行才物理执行。

续接：runs/g2-overnight-20260926/task-state.json；research/g2-overnight-20260926.md。独立分支feat/g2-wuji-overnight-20260926。开发截止北京时间09:07:35，总截止09:52:35。

## Overnight G2 20260926 2026-09-25T22:42:00.188052+00:00

R3-09前后底部支撑通过：末1秒五指100%，固定世界5.020mm/.035022rad；实际去拇指分布接触LP在mu1/2/3均可行（mu.5不可行）。12mm和8mm锚点退出被额外掌部检查拒绝，不启动物理。两种有界约束求解均找到同一整指6mm清空且掌部无相交的姿态，61路径样本通过；R3-10从桌面连续检验四非拇指支撑下整拇指退出与1秒保持。新增仅记录滑块链接接触的诊断字段，未来接近门禁将区分触刀身与触滑块。

续接：runs/g2-overnight-20260926/task-state.json；research/g2-overnight-20260926.md。独立分支feat/g2-wuji-overnight-20260926。开发截止北京时间09:07:35，总截止09:52:35。

## Overnight G2 20260926 2026-09-25T22:36:14.677798+00:00

续接核对本地与远端均9966921；原训练88339实查活跃。R3-07八分支拇指表面屏找到bounded_1几何候选（原两局部分支未找到），尚无到达/保持/操作证据。R3-09前后底部支撑仍在连续运行；已准备真实末态上的单指滑块路径规划，不绕过先支撑再释放。

续接：runs/g2-overnight-20260926/task-state.json；research/g2-overnight-20260926.md。独立分支feat/g2-wuji-overnight-20260926。开发截止北京时间09:07:35，总截止09:52:35。

## Overnight G2 20260926 2026-09-25T22:30:45.851826+00:00

R3-08幅度0.12对照末中指29/30接触、拇指无名指30/30，小指17/30；固定世界8.887mm/.241607rad，四支持目标仍失败，不再增大幅度。R3-07食指前段真接触通过，去拇指LP只在mu3有解、分布接触mu0.5/1/2出现数值Unknown（平均模型mu<=2不可行），不误称数值失败为不可达。假想再加入刀尾小指时mu1/2/3均可解，单指小指路径整指/自身/掌部采样通过。R3-09已从桌面开始检验前后底部支撑组合，仍未执行拇指释放。

续接：runs/g2-overnight-20260926/task-state.json；research/g2-overnight-20260926.md。独立分支feat/g2-wuji-overnight-20260926。开发截止北京时间09:07:35，总截止09:52:35。

## Overnight G2 20260926 2026-09-25T22:22:53.352103+00:00

R3-06移动刀身参考反馈仍未达四支持，末中指0、小指80%，世界8.789mm/.23904rad；修正实际饱和0.08rad，刀相对误差降至约1.04mm但接触仍无。实际Jacobian预测关节3还需+0.0283rad，原关节上限余量0.767rad。R3-08单因素将残差幅度上限0.08→0.12rad，增益3/s、速率.2rad/s、名义轨迹、物理关节/驱动限制及评分不变；54新包络样本无新增自碰。明确不再继续提高此幅度。R3-07食指RRT支撑在途。

续接：runs/g2-overnight-20260926/task-state.json；research/g2-overnight-20260926.md。独立分支feat/g2-wuji-overnight-20260926。开发截止北京时间09:07:35，总截止09:52:35。

## Overnight G2 20260926 2026-09-25T22:18:41.484740+00:00

R3-05原世界校正后继续9度转腕通过，末三支持100%，固定世界6.889mm/0.160192rad。食指先外展两方案仍碰中指，改用一次有界4DOF RRT，32秒/328碰撞检查找到两段单指路径；完整稠密采样通过，额外掌部和自身非相邻5对检查无新增交集。R3-07开始从桌面连续执行R3-03前缀后食指刀底+10mm支撑；仅食指移动，四指保持尚待实测。R3-06物体相对法向控制对照仍运行。

续接：runs/g2-overnight-20260926/task-state.json；research/g2-overnight-20260926.md。独立分支feat/g2-wuji-overnight-20260926。开发截止北京时间09:07:35，总截止09:52:35。

## Overnight G2 20260926 2026-09-25T22:12:45.550826+00:00

R3-04世界法向反馈失败：末中指0%、小指73.3%，世界8.858mm/0.24203rad，反馈峰值0.01572rad未饱和；世界法向残差约-0.009mm，但相对真实移动刀身残差-4.399mm、整中指间隙3.804mm。由此启动R3-06单因素参考帧对照：同名义计划/增益/限幅，只将接触控制目标固定在刀材料坐标并读取实时仿真物体真值；评分世界参考不变，明确控制上界。R3-05仅执行原15度规划中通过完整采样的前9度，后半段预检拒绝，未放宽几何界限。新食指底部+10mm目标端点可达且不相交，仅进入路径碰中指，正在有限比较关节运动次序。

续接：runs/g2-overnight-20260926/task-state.json；research/g2-overnight-20260926.md。独立分支feat/g2-wuji-overnight-20260926。开发截止北京时间09:07:35，总截止09:52:35。

## Overnight G2 20260926 2026-09-25T22:02:25.058773+00:00

R3-03原世界朝向校正通过：末三支持指100%，固定世界5.175mm/0.035575rad；世界旋转误差下降、手内功能角约37.55度，二者区分。R3-02四指平移末世界8.835mm/0.24391rad虽未越界，但中指0、小指66.7%接触，四支持失败。实际中指法向误差0.3–0.63mm，远端负向修正约0.0164rad有余量。R3-04只加相同3/s、±.08rad、.2rad/s的中指法向反馈，54残差包络样本无新自碰、首指令差0；其他控制和门禁同R3-02。
